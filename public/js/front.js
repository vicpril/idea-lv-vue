...
if (api_token) {
  ...
  window.axios.defaults.headers.common["WWW-Authorization"] = "Bearer " + api_token.content;
} // else {
//   console.error(
//     'API token not found'
//   );
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\idea.lv\resources\js\front.js */"./resources/js/front.js");
